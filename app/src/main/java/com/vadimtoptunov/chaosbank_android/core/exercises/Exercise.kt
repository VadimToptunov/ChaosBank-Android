...
object Exercises {
    ...
    private val specs: Map<DefectId, Spec> = mapOf(
        ...
        DefectId.offlineBannerMissing to Spec("middle",
            "Enable offline mode (dev menu network selector) and assert the offline banner is shown on the current screen.",
            "Offline banner visible while offline.", "No banner — the app serves cached data silently.",
            listOf("dev.networkCondition.offline", "net.offlineBanner")),
